...
public class JpaintInterface extends JFrame 
{
	...
	JMenuItem savePaint = new JMenuItem("Enregistrer", new ImageIcon("images/save.png"));
	...
	JButton mSaveTool = new JButton(new ImageIcon("images/save.png"));
	JButton crayonPlus = new JButton(new ImageIcon("images/crayonplus.png"));
	...
	public JpaintInterface()
	{
		...
		this.getContentPane().add(zoneCentrale, BorderLayout.CENTER);
	...
	private void setupMenu()
	{
		...
		{	
			...
			public void actionPerformed(ActionEvent arg0) 
			{
				AboutDialog aboutDialog = new AboutDialog(null, "A propos de PaintSausage", true);
	...
	private void setupToolBar()
	{
		...
		crayonPlus.addActionListener(new ActionListener()
		{
			@Override
			public void actionPerformed(ActionEvent arg0)
			{
		...
		crayonPlus.setToolTipText("Taille du pinceau");

		toolBar.add(mSaveTool);
		toolBar.addSeparator();
		toolBar.add(crayonPlus);
		toolBar.addSeparator();
